...
final class AppearanceStoreTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        suiteName = "com.heatmoment.tests.appearanceStore.\(UUID().uuidString)"
    ...
    func testLoadWithSingleBadRawValueCorrectsOnlyThatAxis() throws {
        ...
        defaults.set("not-a-real-accent-color", forKey: "com.heatmoment.appearance.accentColor")
    ...
    func testLoadWithMultipleBadRawValuesCorrectsExactCount() {
        defaults.set("bogus-accent", forKey: "com.heatmoment.appearance.accentColor")
        defaults.set("bogus-texture", forKey: "com.heatmoment.appearance.backgroundTexture")
    ...
    func testLoadWithBadFeaturedBackgroundCorrectsOnlyFeaturedAxis() throws {
        ...
        defaults.set(
            ...
            forKey: "com.heatmoment.appearance.featuredBackground"
        )
