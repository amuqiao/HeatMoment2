...
| # | 问题 | 裁决 | 落实位置 |
|---|---|---|---|
| 24 | 设置根页是否保留显式关闭按钮 | **移除设置根页左上显式「关闭」按钮**。设置页作为系统 sheet，依赖系统下滑关闭；设置内子页仍保留系统返回按钮。 | 04-screen-specs.md、../current/implementation-truth.md、../plans/implementation-plan.md |
