...
当前生产主 UI、用户写入、完整备份包、本机安全点和 Markdown/PDF 阅读副本导出路径的唯一读写权威是 GRDB canonical store。启动、时间轴、编辑、预览、标签、垃圾箱、统计/热力图、图片读取、备份、阅读副本导出和 UI 测试种子都走 canonical 数据源。
